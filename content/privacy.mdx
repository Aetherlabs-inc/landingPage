...
## 11) Artwork & Image Credits

Artwork images displayed on the AetherLabs website and marketing materials are the original works of **Bandu Manamperi** and are used with the artist's express permission.

**All rights reserved.** These images are protected by copyright and are provided solely for illustrative purposes on AetherLabs platforms. Unauthorized reproduction, distribution, display, or use of these images in any form is strictly prohibited without prior written consent from the artist.

For inquiries regarding the artwork or permission requests, please contact: **legal@aetherlabs.art**
